...
> Super typewriter text animation effect

[![npm version](https://badge.fury.io/js/super-type-writer.svg)](https://www.npmjs.com/package/super-type-writer)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install super-type-writer
```

## Quick Start

```javascript
const { writer } = require('super-type-writer');
...
```javascript
const { writer, batch } = require('super-type-writer');
